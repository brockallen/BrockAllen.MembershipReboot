namespace BrockAllen.MembershipReboot.Nh
{
    ...
    public class NhTwoFactorAuthToken : TwoFactorAuthToken
    {
        /// <summary>
        ...
        public static bool operator ==(NhTwoFactorAuthToken lhs, NhTwoFactorAuthToken rhs)
        {
        ...
        {
            var other = obj as NhTwoFactorAuthToken;
            if (other == null)
            {
                return false;
            }
            ...
            if (!this.IsTransient() && !other.IsTransient())
            {
                ...
                if (userAccountId == otherAccountId && this.Token == other.Token)
                {
        ...
        public override int GetHashCode()
        {
            ...
            else
            {
                unchecked
                {
                    ...
                    this.cachedHashcode = (hashCode * HashMultiplier) ^ this.Token.GetHashCode();
                }
            }
