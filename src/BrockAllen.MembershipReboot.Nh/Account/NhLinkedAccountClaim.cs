namespace BrockAllen.MembershipReboot.Nh
{
    ...
    public class NhLinkedAccountClaim : LinkedAccountClaim
    {
        /// <summary>
        ...
        public static bool operator ==(NhLinkedAccountClaim lhs, NhLinkedAccountClaim rhs)
        {
        ...
        {
            var other = obj as NhLinkedAccountClaim;
            if (other == null)
            {
                return false;
            }
            ...
            {
                if (this.UserAccountId == other.UserAccountId && this.Type == other.Type && this.Value == other.Value)
                {
            ...
            else
            {
                unchecked
                {
                    ...
                    this.cachedHashcode = (hashCode * HashMultiplier)
                                          ...
                                          ^ this.Type.GetHashCode() + (hashCode * HashMultiplier)
