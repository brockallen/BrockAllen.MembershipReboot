namespace BrockAllen.MembershipReboot.Nh
{
    ...
    public class NhUserCertificate : UserCertificate
    {
        /// <summary>
        ...
        public static bool operator ==(NhUserCertificate lhs, NhUserCertificate rhs)
        {
        ...
        {
            var other = obj as NhUserCertificate;
            if (other == null)
            {
                return false;
            }
