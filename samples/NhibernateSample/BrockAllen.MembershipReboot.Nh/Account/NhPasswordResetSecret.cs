namespace BrockAllen.MembershipReboot.Nh
{
    ...
    public class NhPasswordResetSecret : PasswordResetSecret
    {
        /// <summary>
        ...
        public static bool operator ==(NhPasswordResetSecret lhs, NhPasswordResetSecret rhs)
        {
        ...
        {
            var other = obj as NhPasswordResetSecret;
            if (other == null)
            {
                return false;
            }
            ...
            if (!this.IsTransient() && !other.IsTransient())
            {
                ...
                if (userAccountId == otherAccountId && this.PasswordResetSecretID == other.PasswordResetSecretID)
                {
        ...
        public override int GetHashCode()
        {
            ...
            else
            {
                unchecked
                {
                    ...
                    this.cachedHashcode = (hashCode * HashMultiplier) ^ this.PasswordResetSecretID.GetHashCode();
                }
            }
